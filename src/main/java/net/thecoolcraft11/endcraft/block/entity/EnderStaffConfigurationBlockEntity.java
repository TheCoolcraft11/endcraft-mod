...
import net.thecoolcraft11.endcraft.screen.EnderStaffConfigurationScreenHandler;
import org.jetbrains.annotations.Nullable;

public class EnderStaffConfigurationBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    public EnderStaffConfigurationBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.ENDER_STAFF_CONFIGURATION_BLOCK_ENTITY, pos, state);
        this.propertyDelegate = new PropertyDelegate() {
            @Override
            public int get(int index) {
                return switch (index) {
                    case 0 -> EnderStaffConfigurationBlockEntity.this.progress;
                    case 1 -> EnderStaffConfigurationBlockEntity.this.maxProgress;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0 -> EnderStaffConfigurationBlockEntity.this.progress = value;
                    case 1 -> EnderStaffConfigurationBlockEntity.this.maxProgress = value;
                }
            }
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        return new EnderStaffConfigurationScreenHandler(syncId, playerInventory, this, this.propertyDelegate);
    }
