...
public class ModPlacedFeatures {
    ...
    public static void boostrap(Registerable<PlacedFeature> context) {
        ...
        register(context, ENDERITE_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(ModConfiguredFeatures.ENDERITE_KEY),
    ...
    public static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, new Identifier(Endcraft.MOD_ID, name));
    }
